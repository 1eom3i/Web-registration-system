...
#define MYPORT "22678"	// the port users will be connecting to
...
int main(void)
{
    ...
    cout<<"The ServerCS is up and running using UDP on port "<<MYPORT<<"."<<endl;
    ...
    while(1) {
        ...
        if(qlen==1) { //single course
            ...
            cout<<"The ServerCS received a request from the Main Server about the "<<category<<" of "<<course<<"."<<endl;
